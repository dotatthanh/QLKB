                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        @if ($healthCertification->payment_status == 1)
                                            <label class="text-success">Đã thanh toán</label>
                                        @elseif ($healthCertification->payment_status == 2)
                                    ...
                                    @if ($healthCertification->serviceVouchers->count() > 0)
                                        @foreach ($healthCertification->serviceVouchers as $serviceVoucher)
                                    ...
                                    @if ($healthCertification->prescription)
                                        <div class="col-sm-12">
                                            <h4 class="card-title mt-3">Thông tin đơn thuốc</h4>
                                        </div>
                                        <div class="col-sm-2">
